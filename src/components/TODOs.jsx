                    ...
                    <div className="bg-white rounded-xl shadow-md relative">
                        <div className="p-4">
                            ...
                            <div className="mb-5">
                                ...
                                efficitur dolor, et suscipit nisl. Nulla auctor est justo, efficitur
                                cursus purus facilisis eu. Nulla nec hendrerit felis. Morbi non
                                blandit elit. Suspendisse vestibulum sed mauris quis commodo. In a
                                dui in felis tincidunt luctus quis ut nisl. Pellentesque eget
                                finibus turpis. Sed a dui varius, egestas leo interdum, pellentesque
                                mi. Donec ac ante vel neque sagittis commodo vel eget ante.
                            </div>
